...
var searchFlag = true;
var role = "${role}";
var fileUploadRecordLimit = "${ldUiPropertyConfig.smtleadsenderFileUploadRecordsLimit}";
var fileUploadSizeLimit = "${ldUiPropertyConfig.smtleadsenderFileUploadSizeLimit}";
 ...
 <input type=hidden name="hiddenIntegrationName" id="hiddenIntegrationName">
	<div class="container-fluid">
		...
		<!-- Logo and Mobile Toggle Icon Start -->
			...
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center pgTitle">SMT LeadSender-File Upload <span id="titleHeading"></span></div>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1800px;">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-default smtleadsender-blue-btn" id="closeDownloadModelButton" onclick="closeDownloadModal()" data-dismiss="modal">Close</button>
			</div>
		</div>
	</div>
</div>
